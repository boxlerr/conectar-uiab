...
export default function LoadingAdmin() {
  // Sin min-h-screen ni contenedor propio: el <main> del layout de admin ya aporta
  // el alto y el max-w/padding; duplicarlos metía un doble margen en móvil.
  return (
    <div className="bg-slate-50 animate-pulse space-y-6">
      {/* Encabezado */}
