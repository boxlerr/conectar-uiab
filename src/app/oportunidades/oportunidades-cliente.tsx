 ...
 * matches dependen de la sesión), pero ahora recibe las oportunidades abiertas
 * ya resueltas en el servidor.
 *
                      ...
                      <CardContent className="p-5">
                        ...
                        <p className="text-slate-600 mt-3 mb-3 line-clamp-2 text-sm font-inter leading-relaxed">
                          {/* La descripción se carga en un editor enriquecido, así que
                              en la base es HTML. Acá va como texto: sin pasarla a plano
                              se veían las etiquetas ("<p>Necesitamos <b>500 kg…"). */}
