              ...
              <div className="min-w-0">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {(profileDetails.whatsapp || profileDetails.telefono) && (
                    <span className="inline-flex items-center gap-1 px-1.5 py-0.5 bg-emerald-50 text-emerald-700 text-[11px] sm:text-[10px] font-semibold rounded border border-emerald-100">
