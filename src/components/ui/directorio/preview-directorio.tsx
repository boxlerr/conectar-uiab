...
export function PreviewDirectorio() {
  ...
  const branches: BranchTheme[] = [
    {
      id: "empresas",
      title: "Empresas industriales socias UIAB",
      short: "Empresas socias",
      tagline: "Ecosistema industrial socio de la UIAB",
      icon: Package,
      href: "/empresas",
      ctaLabel: "Explorar empresas socias",
      accent: "#10375c",
    ...
    {
      id: "prestadores",
      title: "Prestadores de productos y servicios",
      short: "Prestadores",
      tagline: "Proveedores de productos y servicios (no socios)",
      icon: Wrench,
      href: "/empresas?categoria=proveedores",
      ctaLabel: "Explorar prestadores de productos y servicios",
      accent: "#bf7035",
      accentSoft: "rgba(191,112,53,0.07)",
      accentInk: "#7c3a12",
      glow: "rgba(191,112,53,0.18)",
      image: "/landing/pro-tradesperson.png",
      imageAlt: "Prestador de servicios industriales trabajando",
      demo: {
        badge: "Prestador de servicios",
        initials: "TS",
        nombrePlaceholder: "Tu Servicio Profesional",
        descPlaceholder:
          "Oficios, servicios y productos para la industria y las empresas de la red UIAB.",
        ubicacion: "Zona de cobertura · Alte. Brown y alrededores",
        servicios: ["Rubro", "Servicios", "Disponibilidad", "Zona"],
        certificacion: "Verificado UIAB",
      },
      tipos: [
