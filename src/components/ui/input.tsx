...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        // Ojo: el tamaño de fuente se queda en text-base a todo ancho. Con "md:text-sm" (14px)
        // Safari iOS hace zoom automático al enfocar el campo, y arrancando en md: eso pasaba
        // justo en el iPad. La altura sí escala (h-11 táctil -> h-10 en desktop).
