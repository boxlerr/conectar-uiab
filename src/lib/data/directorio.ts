...
export const entidades: Entidad[] = [
  // Empresas (Radicadas en el parque)
  {
    ...
    descripcionLarga: "Con más de 30 años en el Parque Industrial de Burzaco, Metalúrgica Brown se especializa en el desarrollo, matricería y producción de piezas en aceros aleados para la industria automotriz y el agro.",
    logo: "M",
    ubicacion: "Parque Industrial Almirante Brown, Sector A-12",
  ...
  },
  {
    ...
    logo: "Q",
    ubicacion: "Parque Industrial Almirante Brown, Sector B-8",
  ...
  },
  {
    ...
    logo: "T",
    ubicacion: "Parque Industrial Almirante Brown, Sector I-5",
  ...
  },
  {
    ...
    logo: "A",
    ubicacion: "Parque Industrial Almirante Brown",
    servicios: ["Envasado"],
    destacado: true,
    rating: 4.8,
    reviews: 22,
