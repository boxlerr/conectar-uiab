...
export const CATEGORIAS_SOCIO_META: Record<CategoriaSocio, CategoriaSocioMeta> = {
  proveedores_servicios_productos: {
    ...
    slug: "proveedores",
    nombre: "Empresas y proveedores de servicios",
    nombreCorto: "Proveedores de servicios",
    descripcion: "Empresas industriales socias y proveedores de servicios que ofrecen productos y servicios a la red UIAB.",
    eyebrow: "Socios UIAB · Proveedores de servicios",
